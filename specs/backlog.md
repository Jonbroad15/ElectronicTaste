...
- [x] **Self-Supervised Fine-Tuning of MERT:** Train the MERT encoder further on a large, unlabeled corpus of electronic dance music (e.g., MTG-Jamendo) so it develops a deeper understanding of EDM acoustic structures.
